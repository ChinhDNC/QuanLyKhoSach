 ...
 * @author 84907
 */
public class SK extends javax.swing.JDialog {

    QuanLyDauSach parent;

    public SK(QuanLyDauSach parent) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int res = JOptionPane.showConfirmDialog(rootPane, "Lưu chỉnh sửa", "Xác nhận thay đổi", JOptionPane.YES_NO_OPTION);
...
//            java.util.logging.Logger.getLogger(GT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                GT dialog = new GT(new QuanLyDauSach parent);
