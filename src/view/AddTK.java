...
public class AddTK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên nhập", "Nhân viên xuất" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (new DAO().addTK(tk)) {
            ...
            JOptionPane.showMessageDialog(this, "Thêm thất bại do username đã tồn tại");
...
//            public void run() {
//                new AddTK(QuanlyTK p).setVisible(true);
//            }
//        });
//    }
